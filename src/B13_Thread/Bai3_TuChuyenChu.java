 ...
 * @author hangnt
 */
public class Bai3_TuChuyenChu extends javax.swing.JFrame {

    /**
     * Creates new form Bai3_TuChuyenChu
     */
    public Bai3_TuChuyenChu() {
        initComponents();
        // code
        tuDongNhayChu();
            ...
            public void run() {
                ...
                while (true) {
                    try {
                        ...
                        Logger.getLogger(Bai3_TuChuyenChu.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    jLabel1.setText(txt);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bai3_TuChuyenChu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bai3_TuChuyenChu().setVisible(true);
            }
        });
    }
