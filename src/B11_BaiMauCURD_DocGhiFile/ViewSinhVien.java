...
//        fillData(listSinhVien.size() - 1);
    ...
    private void btnGhiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGhiActionPerformed
        JOptionPane.showMessageDialog(this, new DocGhiFile().ghiFile(path, listSinhVien));
    }//GEN-LAST:event_btnGhiActionPerformed

    private void btnDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDocActionPerformed
        JOptionPane.showMessageDialog(this, new DocGhiFile().docFile(path, listSinhVien));
        showDataTable(listSinhVien);
